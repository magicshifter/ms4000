...
def SendInChunks(ser, dataString, chunkSize, delay):
        l = len(dataString)
        for pos in range(0, l, chunkSize):
...
def issueUpload(device, data, filename):        
        ...
        try:    
                ...
                headerString = list(map(ord,filename))
...
def initMS3000web():
	...
	# original react-based web app
    ser = openPort(5)
    issueUploadMS3000(ser, "settings_ap.bin", "settings/ap.bin")

    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/manifest.json", "manifest.json")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/pure-grid-min.css", "pure-grid-min.css")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/grids-responsive-min.css", "grids-responsive-min.css")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/service-worker.js", "service-worker.js")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/nanopb.proto", "nanopb.proto")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/static/css/main.8fb3b1dc.css", "static/css/main.8fb3b1dc.css")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/static/js/main.6f381e68.js", "static/js/main.6f381e68.js")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/theme.css", "theme.css")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/MS4.proto", "MS4.proto")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/favicon.ico", "favicon.ico")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/asset-manifest.json", "asset-manifest.json")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/pure-min.css", "pure-min.css")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/google/protobuf/descriptor.proto", "google/protobuf/descriptor.proto")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/app/build/index.html", "index.html")
...
def issueUploadMS3000(ser, sourceFilename, targetFilename):     
        ...
        try:    
                ...
                headerString = list(map(ord, targetFilename))
                headerString.insert(0, 0x30)
                headerString.insert(1, 0)
                headerString.insert(2, 0)
                headerString.insert(3, 0)
