...
def initMS3000web():
    ...
    issueUploadMS3000(ser, "settings_ap.bin", "settings/ap.bin")
    sleep(delay)
    issueUploadMS3000(ser, "../../web/dist/bundled/favicon.ico", "favicon.ico")
    sleep(delay)
    ...
    # new-school web interfaces .. 
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/index.html", "index.html")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/pixeleditor/index.html", "pixeleditor/index.html")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/script/pixeleditor.js", "system/script/pixeleditor.js")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/script/app.js", "system/script/app.js")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/1px.png", "system/img/1px.png")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/palette.svg", "system/img/palette.svg")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/pen.svg", "system/img/pen.svg")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/tool.svg", "system/img/tool.svg")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/transparent.jpg", "system/img/transparent.jpg")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/tool.cur", "system/img/tool.cur")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/img/pen.png", "system/img/pen.png")
    #sleep(delay)
    #issueUploadMS3000(ser, "../../web/lite/src/system/css/main.css", "system/css/main.css")
    end = time.time()
    print("time elapsed: ", end - start)
